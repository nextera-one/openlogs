...
__export(index_exports, {
  ...
  compareTPS: () => compareTPS,
  compareTemporalValues: () => compareTemporalValues,
  ...
  extractTPSActor: () => extractTPSActor,
  generateEd25519Keypair: () => generateEd25519Keypair,
  generateTpsUid: () => generateTpsUid,
  groupBySigningKey: () => groupBySigningKey,
  hasTPSLocation: () => hasTPSLocation,
  hasTPSNode: () => hasTPSNode,
  hexToBytes: () => hexToBytes,
  normalizeTPS: () => normalizeTPS,
  ...
  validateRecordPolicy: () => validateRecordPolicy,
  validateTPS: () => validateTPS,
...
function parseTPS(input) {
  ...
  try {
    const parsedValue = normalizeParsedValue(import_tps_standard.TPS.parse(tps));
...
function normalizeParsedValue(parsed) {
  ...
  if (typeof parsed === "string") {
    const reparsed = import_tps_standard.TPS.parse(parsed);
